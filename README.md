...
Add_book prompts the user to input the book details such as title, author, year (optional), and genre. It validates the input and adds the book to the sheet. It then prompts the user if they want to add another book.
